          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return axios__WEBPACK_IMPORTED_MODULE_0___default()("https://api.fnugg.no/search?q=".concat(query));

                case 2:
                  result = _context.sent;
                  result.data.hits.hits.map(function (item) {
                    return setItemData(item._source);
                  });
